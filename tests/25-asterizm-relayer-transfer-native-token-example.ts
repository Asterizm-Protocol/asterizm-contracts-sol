...
import {getPayerFromConfig, nativeTokenClientOwner, trustedUserAddress} from "./utils/testing";
...
describe("Asterizm relayer transfer message for native token example", () => {
